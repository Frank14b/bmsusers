...
class UsersController extends BaseApiController
{
    ...
    public function createUser()
    {
        ...
        $checkAuthRoute = $this->checkAuthRoute(); // check if api route is authorized to the user
        //if($checkAuthRoute != "true"){ return $this->checkAuthRoute(); }; // check if api route is authorized to the user
    ...
    public function getAll()
    {
        ...
        $checkAuthRoute = $checkAuthRoute = $this->checkAuthRoute(); // check if api route is authorized to the user
        //if($checkAuthRoute != "true"){ return $this->checkAuthRoute(); }; // check if api route is authorized to the user
    ...
    public function generateUserToken($userid, $prefix = "Api")
    {
        ...
        $permission_file = "/Admin-jwt/jwt.key";
